...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-163831576-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-163831576-1');
</script>
    <meta charset="utf-8"/>
...
<header class="header pos-re slider-fade" data-scroll-index="0">
    ...
    <div class="owl-carousel owl-theme">
        <div class="item bg-img" data-overlay-dark="5" data-background="img/zeal.gif">
            <div class="text-center v-middle caption mt-30">
                <h4>We Are</h4>
                <h1>Big Digital Agency</h1>
                <div class="row">
                    <div class="offset-md-1 col-md-10 offset-lg-2 col-lg-8">
                        <p>We’re a dedicated group of talented and creative professionals. We’re experienced. We’re
                            honest, good and fun to hang out with. You’ll like us. whenever you try us</p>
                    </div>
                </div>
                <a href="#price" class="butn butn-light mt-30">
                    <span>Advertise Here</span>
                </a>
            </div>
        </div>
        <div class="item bg-img" data-overlay-dark="5" data-background="img/namba4.gif">
            <div class="text-center v-middle caption mt-30">
                <h4>We Are</h4>
                <h1>Big Digital Agency</h1>
                <div class="row">
        ...
        <div class="item bg-img" data-overlay-dark="5" data-background="img/namba1.gif">
            <div class="text-center v-middle caption mt-30">
                <h4>We Are</h4>
                <h1>Big Digital Agency</h1>
                <div class="row">
		        ...
		        <div class="item bg-img" data-overlay-dark="5" data-background="img/sell-today.jpg">
            <div class="text-center v-middle caption mt-30">
                <h4>We Are</h4>
                <h1>Big Digital Agency</h1>
                <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="offset-lg-2 col-lg-8 offset-md-1 col-md-10 text-center mb-80">
                    ...
                    <p>We grow other people's brands, and help them get results. </p>
                </div>
                ...
                <div class="feat-item mb-md50 col-lg-4">
                    <div class="text-center">
                        ...
                        <h5>Web Profile</h5>
                        <h6>Modern & Clean Profile</h6>
                        <p>
                            Allows you communicate and interact with your clients through our active platform and
                            prospects through our active platform.We have a dedicated web profile development team.
                            With our professional team, you will get a modern and clean profile.
                        </p>
                    </div>
                </div>
                ...
                <div class="feat-item active mb-md50 col-lg-4">
                    <div class="text-center">
                        ...
                        <h6>Strong & Active Online Presence</h6>
                        <p>
                            We conduct successful marketing campaign in all social media platforms. We have a digital
                            marketing team that transforms your business and reach your audience and help you get
                            results. Once you try us, you’ll always like us.
                        </p>
                    </div>
                </div>
                ...
                <div class="feat-item col-lg-4">
                    <div class="text-center">
                        ...
                        <p>
                            Have strong visual identity for your business products and styles. Strong Brand visibility
                            strategies goes here. With us, you’ll be provided with strong branding strategies.
                            We will help you grow your business from logo to a brand book that will identify and
                            distinguish you in the market place.
                        </p>
                    </div>
                </div>
                ...
                <ul class="col-md-12 nav nav-pills tabs" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item two">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#tab2" role="tab"
                           aria-controls="tab2" aria-selected="false">Our Mission & Vision</a>
                    </li>
                    ...
                    <!-- <li class="nav-item four">
                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false">Who we serve?</a>
                    </li>-->
                        ...
                        <div class="row">
                            <div class="left col-lg-6">
                                <div class="about box-white">
                                    ...
                                    <p>We’re a dedicated group of talented and creative professionals. We’re
                                        experienced. We’re honest, good and fun to hang out with. You’ll like us.
                                        whenever you try us.</p>

                                    <h3><p><b>What we do</b></p></h3>

                                    <p>We grow other people's brands, and help them get results.
                                        <li>
                                    <p>We create unique experiences that attract, engage and convert new customers to
                                        your business.</p></li>
                                    <li><p>We use creative and proven digital strategies to build brand campaigns for
                                        you.</p></li>
                                    </p>
                        ...
                        <div class="row">
                            <div class="left col-lg-6">
                                <div class="mission box-white">
                                    <h5 class="title">Our Mission & Vision</h5>
                                    <h6 class="sub-title">We Are A Creative Agency</h6>
                                    <h4>Mission</h4>
                                    <p class="mb-10">'Growing brands and Partnership inorder to enhance brand
                                        visibility' </p>
                                    <h4>Vision</h4>
                                    <p class="mb-10">To be the leading East Africa digital marketing agency by growing
                                        people's brands and enhancing customer relations </p>
                    ...
                    <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
                            <div class="left col-lg-6">
                                <div class="why-us box-white">
                                    ...
                                    <h6 class="sub-title">We Are A Creative Agency</h6>
                                    <p>Knowing that there are plenty of great agencies out there, with great creative
                                        people, we therefore differentiate ourselves through our process and our
                                        partnerships with clients. We work hand in hand with clients, soliciting
                                        feedback and guiding them through the process each step of the way. And when we
                                        say “Growing brands and partnership” we mean it. And you can always call us for
                                        help and we will answer at inopportune times.
                                    </p>
                                    <p>Since it’s your brand we’re here to grow it and help you share it with the world
                                        very fast</p>
                        ...
                        <!--<div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="pills-home-tab">
                             <div class="row">
                                 <div class="left col-lg-6">
                                     <div class="mission box-white">
                                         <h5 class="title">Who We Serve?</h5>
                                         <h6 class="sub-title">We Are A Creative Agency</h6>

                                         <p class="mb-10">We don’t limit our work to any single industry, and we don’t discriminate based on company size. We always work with every single person who trusts us and let us grow the brand for them. We've worked with many clients across a variety of industries/companies for over two years now giving us a vast reservoir of experience and best practices that inform our approach to each new project. </p>
...
<div class="process section-padding bg-img bg-fixed pos-re text-center" data-overlay-dark="7" data-background="img/zeal.gif">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="item first mb-md50">
                    ...
                    <div class="cont">
                        ...
                        <h6>Ideas</h6>
                        <p>
                            Anything starts from the scratch, with us you will have an opportunity
                            to build your idea. We’re here to help you generate ideas that will be turned into
                            businesses. We will drop you an exciting business
                            idea and you will always like us.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="item odd mb-md50">
                    ...
                    <div class="cont">
                        <h3>02</h3>
                        <h6>Screening & planing</h6>
                        <p>
                            At this stage, we will screen the idea and plan all the required things for the idea to get
                            implemented. It is the process where we can now put the idea to look more realistic.
                            At this stage, we will plan on how the idea will be put into actions.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="item mb-sm50">
                    ...
                    <div class="cont">
                        ...
                        <p>
                            At this process, we are now coming into action. Having analyzed all the required materials
                            and how it the idea will be put into actions, we therefore develop your business.
                            You can now call us “business developers” it is the stage where you will need to start
            ...
            <div class="col-lg-3 col-md-6">
                <div class="item odd">
                    ...
                    <div class="cont">
                        ...
                        <p>
                            At this stage, you’re now available in the market place, it is the stage where the brand
                            needs to be visible. Brand visibility becomes a more valuable feature so that to make
                            awareness of your business to the target market.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="testimonials section-padding bg-img bg-fixed pos-re" data-overlay-dark="7"
         data-background="img/namba4.gif">
    <div class="container">
        <div class="row">
            ...
            <div class="owl-carousel owl-theme text-center col-lg-10 offset-lg-1">
                <div class="item-box">
                    ...
                    <p>
                        This site is very helpful. Having tried it has made my business reach more people.
                        You’re awesome guys!
                    </p>
                    <div class="info">
                ...
                <div class="item-box">
                    ...
                    <p>
                        You’ve real made my business grow. Now my brand has become visible compared to previous days.
                    </p>
                    <div class="info">
                        <div class="author-img">
                ...
                <div class="item-box">
                    ...
                    <p>
                        Having used this platform, has made me reach thousands of people.
                        Imagine! You’re so great.
                    </p>
                    <div class="info">
                        <div class="author-img">
...
<section id="price" class="price section-padding bg-gray pos-re" data-scroll-index="4">
    <div class="container">
        <div class="row">
                ...
                <div class="row d-flex justify-content-center align-item-center">
                    ...
                    <div class="col-lg-3">
                        <div class="item mb-md50">
                            ...
                            <div class="value">
                                <h3><span>TZS</span>40,000</h3>
                                <span class="per">/ Week</span>
                            </div>

                            <div class="features">
                                <ul>
                                    <li>Unlimited online poster</li>
                                    <li>Social media promotion</li>
                                </ul>
                            </div>

                            <div class="order">
                                <a href="https://wa.me/255713858394?text=Nahitaji%20kujiunga%20na%20huduma%20ya%20basic%20advertising.%20Ahsante."
                                   target="_blank" class="butn butn-bg">
                                    <span>Book Now</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="item mb-md50">
                            ...
                            <div class="features">
                                <ul>
                                    ...
                                    <li>Social media promotion</li>
                                    <li>
                                        Your advert will be displayed at our website,
                                        and people can direct communicate with you
                                    </li>
                                </ul>
                            </div>

                            <div class="order">
                                <a href="https://wa.me/255713858394?text=Nahitaji%20kujiunga%20na%20huduma%20ya%20standard%20advertising.%20Ahsante."
                                   target="_blank" class="butn butn-bg">
                                    <span>Book Now</span>
                                </a>
                            </div>
                        ...
                        <div class="item active mb-md50">
                            ...
                            <div class="features">
                                <ul>
                                    ...
                                    <li>
                                        Web profile for your company
                                    </li>
                                </ul>
                            </div>

                            <div class="order">
                                <a href="https://wa.me/255713858394?text=Nahitaji%20kujiunga%20na%20huduma%20ya%20premium%20advertising.%20Ahsante."
                                   target="_blank" class="butn butn-light">
                                    <span>Book Now</span>
                                </a>
                            </div>
                        </div>
...
<section class="call-action section-padding bg-img bg-fixed" data-overlay-dark="5" data-background="img/namba1.gif">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="text-center">
                    ...
                    <a href="https://wa.me/255713858394?text="
                       target="_blank" class="butn butn-bg">
...
<footer class="text-center pos-re">
    <div class="container">
        ...
        <p>&copy; 2020 SellTody. All Rights Reserved.</p>
    </div>
